...
export default class MedicalDeclaration extends mixins(JhiDataUtils) {
  ...
  public medicalDeclarations: IMedicalDeclaration[] = [];

  public isFetching = false;

  public mounted(): void {
    this.retrieveAllMedicalDeclarations();
  }
  ...
  public retrieveAllMedicalDeclarations(): void {
        ...
        res => {
          if (res.data && res.data.length > 0) {
            for (let i = 0; i < res.data.length; i++) {
              this.medicalDeclarations.push(res.data[i]);
            }
  ...
  public prepareRemove(instance: IMedicalDeclaration): void {
  ...
  public removeMedicalDeclaration(): void {
    this.medicalDeclarationService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('golfCheckingUiApp.medicalDeclaration.deleted', { param: this.removeId });
